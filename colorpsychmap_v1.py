"""
colorpsychmap_v1.py — ColorPsychMap v1
Analiza koloru (HSV): wykrywa skoki Hue/Saturation/Value klatka-do-klatki.

Kanoniczna nazwa pliku (patrz "COLORPSYCHMAP v1.py" — cienki re-eksport
zachowany dla wstecznej zgodności, bo nazwa ze spacją nie da się
zaimportować standardowym `import`).
